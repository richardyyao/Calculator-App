...
public class NonConsumptionActivity extends AppCompatActivity {
    ...
    // The product ID of RemoveAds which is a non-consumable product.
    private static final String REMOVE_ADS_PRODUCTID = "RemoveAds1";

    // The Adapter for nonconsumableProductListview.
    private ProductListAdapter productListAdapter;

    // Show this layout when RemoveAds has been purchased.
    private LinearLayout hasPurchasedRemoveAdsLayout;

    // Whether RemoveAds has been purchased.
    ...
    private void initView() {
        ...
        hasPurchasedRemoveAdsLayout = (LinearLayout) findViewById(R.id.layout_hasOwnedRemoveAds);
    }
    ...
    /**
     * Checking the Purchase Status of Remove Ads.
     *
    ...
    private void checkRemoveAdsPurchaseState(OwnedPurchasesResult result) {
            ...
            if (CipherUtil.doCheck(inAppPurchaseDataList.get(i), inAppSignature.get(i), CipherUtil.getPublicKey())) {
                try {
                    ...
                    if (inAppPurchaseDataBean.getPurchaseState() == InAppPurchaseData.PurchaseState.PURCHASED) {
                        // Check whether the purchased product is RemoveAds.
        ...
        if (isRemoveAdsPurchased) {
            // Deliver the product after RemoveAds was purchased.
            deliverProduct();
        } else {
            // The user has not purchased RemoveAds.
    ...
    private void deliverProduct() {
        // User has purchased RemoveAds level.
        findViewById(R.id.progressBar).setVisibility(View.GONE);
        findViewById(R.id.content).setVisibility(View.VISIBLE);

        nonconsumableProductListview.setVisibility(View.GONE);
        hasPurchasedRemoveAdsLayout.setVisibility(View.VISIBLE);
    }
    ...
    private void queryProducts() {
        ...
        productIds.add(REMOVE_ADS_PRODUCTID);
    ...
    private void showProducts() {
        ...
        hasPurchasedRemoveAdsLayout.setVisibility(View.GONE);
